...
class MatchPlayedAt extends React.Component {
    ...
    static getDerivedStateFromProps(nextProps, prevState){
        if (prevState.matchPerVenue !== nextProps.matchPerVenue || prevState.matchPerCity !== nextProps.matchPerCity || prevState.matchPerCountry !== nextProps.matchPerCountry) {
            return {
      ...
      <div className='match-played'>
        <div className="select-option">
            <Select placeholder="Select option" onChange={this.onChangeOption}>
                <option selected value="matchPerVenue">Venue</option>
        ...
        <div className="match-player-vis">
            ...
            <Tooltip><span className="vis-tooltip">{hoveredNode && hoveredNode.data.tooltip}</span></Tooltip>
            </div>
        </div>
      </div>
    );
